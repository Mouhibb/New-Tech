...
#partenaires td, #directions th {
  border: 1px solid #ddd;
  padding: 8px;
}

#partenaires tr:nth-child(even){background-color: #f2f2f2;}

#partenaires tr:hover {background-color: #ddd;}
...
<h2 style="color:grey; font-family: Arial, Helvetica, sans-serif; text-align:center;">Liste des partenaires</h2>
<hr>
...
<c:forEach items="${listPartenaires}" var="l">

<tr>
<td>${l.nom_partenaire}</td>
<td>${l.email}</td>
</tr>
</c:forEach>
</table>
