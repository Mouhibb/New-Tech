...
<body>
  ...
  <div class="d-flex" id="wrapper">
   ...
   <form action="ResponsableServlet2" style="padding-left: 10px;" class="was-validated" method="post">




<div class="form-group">
   <label for="uname">Année :</label>
    <input type="number" style=" width:30%;" class="form-control" id="uname"  placeholder="Enter l'année de l'activité" name="année" required>
...
<div class="form-group">
    ...
    <input type="text" style=" width:30%;" class="form-control" id="uname" placeholder="Enter l'état de l'activité" name="état" required>
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
