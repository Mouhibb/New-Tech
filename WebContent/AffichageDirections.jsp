...
<div id="page-content-wrapper">
      ...
      <hr>
<div >
  <h3 style="color:grey; font-family: Arial, Helvetica, sans-serif; text-align:center;">Liste des directions</h3>
  <hr>
   <table id="directions">
     <tr>
    <th>Nom</th>
...
<c:forEach items="${listDirections}" var="l">

<tr>
<td>${l.nom_direction}</td>
<td>${l.email}</td>
</tr>
</c:forEach>
</table>
